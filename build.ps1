...
docker run --rm -v "$($PWD):/src" -w /src/container-desktop/ContainerDesktop/bin/Release/net6.0-windows10.0.19041.0/win-x64/publish container-desktop-tools:build zip -r9 /src/dist/container-desktop.zip .
# Publish installer
