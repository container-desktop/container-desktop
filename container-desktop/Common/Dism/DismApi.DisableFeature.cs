...
public static partial class DismApi
{
    ...
    public static void DisableFeature(DismSession session, string featureName, string packageName, bool removePayload = false)
    {
    ...
    /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
    public static void DisableFeature(DismSession session, string featureName, string packageName, bool removePayload, Dism.DismProgressCallback progressCallback)
    {
    ...
    /// <exception cref="OperationCanceledException">When the user requested the operation be canceled.</exception>
    /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
    public static void DisableFeature(DismSession session, string featureName, string packageName = null, bool removePayload = false, Dism.DismProgressCallback progressCallback = null, object userData = null)
    {
