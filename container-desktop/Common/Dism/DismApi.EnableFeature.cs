...
namespace Microsoft.Dism
{
    public static partial class DismApi
    {
        ...
        /// <param name="userData">Optional user data to pass to the DismProgressCallback method.</param>
        /// <exception cref="DismException">When a failure occurs.</exception>
        public static void EnableFeature(DismSession session, string featureName, bool limitAccess = false, bool enableAll = false, List<string> sourcePaths = null, Microsoft.Dism.DismProgressCallback progressCallback = null, object userData = null)
        {
